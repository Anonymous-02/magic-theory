$(function(){
    ...
    content +='<a href="https://qm.qq.com/cgi-bin/qm/qr?k=_WETFhR5KeqdgsMcbxUgIltMCRA_Py3Y&jump_from=webapi" target="_blank" class="im-qq qq-a" title="点击加入 - 魔法理论交流群:281738137">';
    content +='<div class="qq-container"></div>';
    content +='<div class="qq-hover-c"><img class="img-qq" src="https://cdn.jsdelivr.net/gh/g8hh/g8hh.github.io/static/static/images/kf/qq.png"></div>';
    content +='<span>点击加群</span>';
    content +='</a>';
    content +='<div class="im-tel">';
    content +='<div>QQ群号:</div>';
    content +='<div class="tel-num">281738137</div>';
    content +='<div>更多同类游戏:</div>';
    content +='<div class="tel-num"><a href="http://www.gityx.com" target="_blank" title="Git游戏：gityx.com~">Git游戏</a><a href="http://g8hh.com" target="_blank" style="margin-left:5px;" title="锅巴汉化：g8hh.com">锅巴汉化</a><br /><a href="http://bbs.gityx.com/" target="_blank" style="margin-left:5px;" title="点击查看游戏攻略">游戏攻略交流论坛</a><br /></div>';
    content +='</div>';
